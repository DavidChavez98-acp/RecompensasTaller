...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <InputPrimitive
      ...
      data-slot="input"
      className={cn(
        // h-11 (44px): mismo mínimo táctil que Button. Un input de cédula,
        // código OTP o monto que un cliente o asesor teclea de pie merece el
        // mismo tamaño que el botón que lo envía.
